    ...
    <DayPicker
      ...
      classNames={{
        ...
        nav_button: cn(
          ...
          "h-7 w-7 bg-transparent p-0 opacity-50 hover:opacity-100 border-pizza-orange/30",
        ),
        ...
        day: cn(
          ...
          "h-9 w-9 p-0 font-normal aria-selected:opacity-100 text-white hover:bg-pizza-orange/20",
        ),
        day_range_end: "day-range-end",
        day_selected:
          "bg-pizza-orange text-white hover:bg-pizza-orange hover:text-white focus:bg-pizza-orange focus:text-white",
        day_today: "bg-pizza-orange/20 text-white",
        day_outside:
